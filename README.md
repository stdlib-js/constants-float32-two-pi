...
```javascript
FLOAT32_TWO_PI = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-two-pi@v0.1.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-two-pi@v0.1.1-umd/browser.js"></script>
```
